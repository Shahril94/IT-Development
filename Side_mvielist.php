                    ...
                    <?php
                        ...
                        while($row1 = mysqli_fetch_array($table))
                        {
                            ...
                            echo '<td><button style ="width: 120px; padding: 20px; cursor: pointer;   
                                ...
                                background: #ffff00; color: #000; border-radius: 10px; border: 1px solid #999; font-size: 150%"><a href="EditMovie.php?id='.$row1["ID"].'";>Edit</a></button><button style ="width: 120px; padding: 20px; cursor: pointer;   
                                box-shadow: 6px 6px 5px;  -webkit-box-shadow: 6px 6px 5px #999; -moz-box-shadow: 6px 6px 5px #999; font-weight: bold; 
                                background: #ffff00; color: #000; border-radius: 10px; border: 1px solid #999; font-size: 150%"><a href="DeleteDataMovie.php?id='.$row1["ID"].'";>Delete</a></button></td>';
                        }
                        echo "</tr>";
                        echo "</table>";                        
